...
public class TaskTest {
	...
	public void constructorTest_WithRequireResourceTypes(){
		...
		map.put(rt, 3);
		Task t = new Task(description, estimatedDuration, acceptableDeviation, null, null, map);
		assertEquals(t.getDescription(), description);
		assertEquals(t.getEstimatedDuration(), estimatedDuration);
		assertEquals(t.getAcceptableDeviation(), acceptableDeviation);
		assertTrue(t.getDependencies().isEmpty());
	...
	public void constructorTest_WithAlternativeFor(){
		...
		Task t2 = new Task(description, estimatedDuration, acceptableDeviation, null, t, null);
...
//	}
	...
	public void calculateTotalExecutionTimeTest_TrueCase_Alternative() {
		...
		TimeSpan timeSpan2 = new TimeSpan(new DateTime(2015,10,12,8,0), new DateTime(2015,10,12,16,0));
	...
	public void addRequiredResourceTest_SelfConflicting(){
		...
		HashMap<ResourceType,Integer> map = new HashMap<ResourceType, Integer>();
		map.put(r, 1);
		Task t = new Task(description, estimatedDuration, 0, null, null, map);
		
		t.addRequiredResourceType(r, 1);
	}
	
	@Test (expected = IllegalArgumentException.class)
	public void addRequiredResourceTest_Conflicting(){
		
		ResourceType r1 = new ResourceType("name", null, null, false);
		ArrayList<ResourceType> c = new ArrayList<ResourceType>();
		c.add(r1);
		ResourceType r2 = new ResourceType("name", null, c, true);
	
		HashMap<ResourceType,Integer> map = new HashMap<ResourceType, Integer>();
		map.put(r2, 1);
		Task t = new Task(description, estimatedDuration, 0, null, null, map);
		
		t.addRequiredResourceType(r1, 1);
	}
	...
	public void addRequiredResourceTest_ToMuchAdded(){
		...
		ResourceType r2 = new ResourceType("name", null, null, true);
	
		HashMap<ResourceType,Integer> map = new HashMap<ResourceType, Integer>();
		map.put(r2, 1);
		Task t = new Task(description, estimatedDuration, 0, null, null, map);
		
		t.addRequiredResourceType(r2, 3);
	}
