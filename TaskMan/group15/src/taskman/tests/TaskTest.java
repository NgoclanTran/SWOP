...
public class TaskTest {
	...
	private Clock clock = branchOffice.getClock();
	...
	public void constructor1Test_FalseCase_EstimatedDuration() {
		...
		// Task t = new Task(clock,description, -10, acceptableDeviation,
		// dependencies,
		// null, null);
	...
	public void constructor1Test_FalseCase_acceptableDeviation() {
		...
		// Task t = new Task(clock,description, estimatedDuration, -10,
		// dependencies,
		// null, null);
	}
	...
	public void updateTaskAvailabilityTest_TrueCase_StatusPLANNED() {
		...
		Developer d = new Developer("name", new LocalTime(8, 0), new LocalTime(16, 0));
		TimeSpan timeSpan = new TimeSpan(new DateTime(2015, 10, 13, 8, 0), new DateTime(2015, 10, 13, 16, 0));
		d.addReservation(t, timeSpan);
		t.addRequiredDeveloper(d);
		t.update();
	...
	public void updateTaskAvailabilityTest_ResourceAvailableTest() {
		...
		NormalTask t1 = branchOffice.getPh().getProjects().get(0).getTasks().get(0);
		rt.getResources().get(0).addReservation(t1,
				new TimeSpan(new DateTime(2015, 10, 12, 11, 11), new DateTime(2015, 10, 14, 10, 0)));
		Developer d = new Developer("name developer 1", new LocalTime(8, 0), new LocalTime(23, 0));
		d.addReservation(t1, new TimeSpan(new DateTime(2015, 10, 12, 11, 11), new DateTime(2015, 10, 14, 10, 0)));
		t1.addRequiredDeveloper(d);
	...
	public void calculateOverduePercentageTest_TrueCase() {
		...
		assertEquals(t.getOverduePercentage(), (60 - this.estimatedDuration) * 100 / this.estimatedDuration);
	...
	public void isSeveralyOverDueTest_StatusFINISHED() {
		...
		NormalTask t = branchOffice.getPh().getProjects().get(0).getTasks().get(0);
		Developer d = new Developer("name", new LocalTime(8, 0), new LocalTime(16, 0));
		TimeSpan timeSpan = new TimeSpan(new DateTime(2015, 10, 12, 8, 0), new DateTime(2015, 10, 12, 9, 0));
		d.addReservation(t, timeSpan);
		t.addRequiredDeveloper(d);
		t.update();
		DateTime startTime = new DateTime(2015, 1, 1, 10, 0);
	...
	public void addDeveloperTest_TrueCase() {
		...
		p.addTask(description, estimatedDuration, 0, null, null, null, 1);
		NormalTask t = branchOffice.getPh().getProjects().get(0).getTasks().get(0);
		Developer developer = new Developer("1", new LocalTime(8, 0), new LocalTime(16, 0));
	...
	public void gerRequiredResourceTest() {
		...
		p.addTask(description, estimatedDuration, 0, null, null, null, 1);
		NormalTask t = branchOffice.getPh().getProjects().get(0).getTasks().get(0);
		HashMap<ResourceType, Integer> l = (HashMap<ResourceType, Integer>) t.getRequiredResourceTypes();
	...
	public void addRequiredResourceTest_SelfConflicting() {
		...
		r.addResource("effective resource 1", new LocalTime(0, 0), new LocalTime(23, 59));
		r.addResource("effective resource 2", new LocalTime(0, 0), new LocalTime(23, 59));
	...
	public void addRequiredResourceTest_Conflicting1() {
		...
		r1.addResource("effective resource 1", new LocalTime(0, 0), new LocalTime(23, 59));
		ArrayList<ResourceType> c = new ArrayList<ResourceType>();
		c.add(r1);
		ResourceType r2 = new ResourceType("resource 2", null, c, false);
		r2.addResource("effective resource 2", new LocalTime(0, 0), new LocalTime(23, 59));
	...
	public void addRequiredResourceTest_AddRequiredFirst() {
		...
		t1.addResource("effective resource 1", new LocalTime(0, 0), new LocalTime(23, 59));
	...
	@Test
	public void updateStatus_Status_EXECUTING() {
		branchOffice.getPh().addProject("", "", new DateTime(), new DateTime());
		Project p = branchOffice.getPh().getProjects().get(0);
		p.addTask(description, estimatedDuration, acceptableDeviation, null, null, null, 1);
		NormalTask t = branchOffice.getPh().getProjects().get(0).getTasks().get(0);
